...
//	    }
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/api/user", "/api/role").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.POST, "/api/Student").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.PUT, "/api/Student").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.DELETE, "/api/Student/*").hasAuthority("ADMIN")
